          ...
          <div className="flex-row">
            ...
            <div className="flex flex-col gap-2 ">
              ...
              <div className="flex  flex-row rounded-lg border-[#0089D3] border-3">
                <div className="image bg-[#0089D3] w-[94px] h-[94px] flex flex-none justify-center items-center">
                  <Image
                    src={"/announcementIcon.png"}
                    alt="logo"
                    width={74}
                    height={74}
                  />
                </div>
                <Link href={"/announcement_view"} className="flex flex-col justify-center px-2">
                  <p className="font-bold text-lg text-primary m-0">ติดตามข่าวประชาสัมพันธ์</p>
                  <p className="text-secondary">ดูข่าวประชาสัมพันธ์ที่ประกาศไปแล้วทั้งหมด</p>
                </Link>
